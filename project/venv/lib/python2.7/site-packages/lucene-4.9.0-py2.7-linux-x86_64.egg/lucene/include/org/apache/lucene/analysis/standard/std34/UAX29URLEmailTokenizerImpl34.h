#ifndef org_apache_lucene_analysis_standard_std34_UAX29URLEmailTokenizerImpl34_H
#define org_apache_lucene_analysis_standard_std34_UAX29URLEmailTokenizerImpl34_H
      ...
      namespace analysis {
        namespace standard {
          namespace std34 {
            ...
            class UAX29URLEmailTokenizerImpl34 : public ::java::lang::Object {
            public:
              enum {
                mid_init$_cf2e3c10,
              ...
              explicit UAX29URLEmailTokenizerImpl34(jobject obj) : ::java::lang::Object(obj) {
                if (obj != NULL)
                  env->getClass(initializeClass);
              }
              UAX29URLEmailTokenizerImpl34(const UAX29URLEmailTokenizerImpl34& obj) : ::java::lang::Object(obj) {}
              ...
              UAX29URLEmailTokenizerImpl34(const ::java::io::Reader &);
  ...
  namespace apache {
    namespace lucene {
      namespace analysis {
        namespace standard {
          namespace std34 {
            extern PyTypeObject PY_TYPE(UAX29URLEmailTokenizerImpl34);

            class t_UAX29URLEmailTokenizerImpl34 {
            public:
              PyObject_HEAD
              UAX29URLEmailTokenizerImpl34 object;
              static PyObject *wrap_Object(const UAX29URLEmailTokenizerImpl34&);
