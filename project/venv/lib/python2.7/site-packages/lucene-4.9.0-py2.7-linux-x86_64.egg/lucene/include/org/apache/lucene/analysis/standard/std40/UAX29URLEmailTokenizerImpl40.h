#ifndef org_apache_lucene_analysis_standard_std40_UAX29URLEmailTokenizerImpl40_H
#define org_apache_lucene_analysis_standard_std40_UAX29URLEmailTokenizerImpl40_H
      ...
      namespace analysis {
        namespace standard {
          namespace std40 {
            ...
            class UAX29URLEmailTokenizerImpl40 : public ::java::lang::Object {
            public:
              enum {
                mid_init$_cf2e3c10,
              ...
              explicit UAX29URLEmailTokenizerImpl40(jobject obj) : ::java::lang::Object(obj) {
                if (obj != NULL)
                  env->getClass(initializeClass);
              }
              UAX29URLEmailTokenizerImpl40(const UAX29URLEmailTokenizerImpl40& obj) : ::java::lang::Object(obj) {}
              ...
              UAX29URLEmailTokenizerImpl40(const ::java::io::Reader &);
  ...
  namespace apache {
    namespace lucene {
      namespace analysis {
        namespace standard {
          namespace std40 {
            extern PyTypeObject PY_TYPE(UAX29URLEmailTokenizerImpl40);

            class t_UAX29URLEmailTokenizerImpl40 {
            public:
              PyObject_HEAD
              UAX29URLEmailTokenizerImpl40 object;
              static PyObject *wrap_Object(const UAX29URLEmailTokenizerImpl40&);
