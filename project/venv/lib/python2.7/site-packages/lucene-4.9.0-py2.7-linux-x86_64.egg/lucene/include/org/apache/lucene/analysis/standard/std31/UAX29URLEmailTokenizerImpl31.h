#ifndef org_apache_lucene_analysis_standard_std31_UAX29URLEmailTokenizerImpl31_H
#define org_apache_lucene_analysis_standard_std31_UAX29URLEmailTokenizerImpl31_H
      ...
      namespace analysis {
        namespace standard {
          namespace std31 {
            ...
            class UAX29URLEmailTokenizerImpl31 : public ::java::lang::Object {
            public:
              enum {
                mid_init$_cf2e3c10,
              ...
              explicit UAX29URLEmailTokenizerImpl31(jobject obj) : ::java::lang::Object(obj) {
                if (obj != NULL)
                  env->getClass(initializeClass);
              }
              UAX29URLEmailTokenizerImpl31(const UAX29URLEmailTokenizerImpl31& obj) : ::java::lang::Object(obj) {}
              ...
              UAX29URLEmailTokenizerImpl31(const ::java::io::Reader &);
  ...
  namespace apache {
    namespace lucene {
      namespace analysis {
        namespace standard {
          namespace std31 {
            extern PyTypeObject PY_TYPE(UAX29URLEmailTokenizerImpl31);

            class t_UAX29URLEmailTokenizerImpl31 {
            public:
              PyObject_HEAD
              UAX29URLEmailTokenizerImpl31 object;
              static PyObject *wrap_Object(const UAX29URLEmailTokenizerImpl31&);
