#ifndef org_apache_lucene_codecs_lucene42_Lucene42Codec_H
#define org_apache_lucene_codecs_lucene42_Lucene42Codec_H
    ...
    namespace lucene {
      namespace codecs {
        namespace lucene42 {
          ...
          class Lucene42Codec : public ::org::apache::lucene::codecs::Codec {
          public:
            enum {
              mid_init$_54c6a166,
            ...
            explicit Lucene42Codec(jobject obj) : ::org::apache::lucene::codecs::Codec(obj) {
              if (obj != NULL)
                env->getClass(initializeClass);
            }
            Lucene42Codec(const Lucene42Codec& obj) : ::org::apache::lucene::codecs::Codec(obj) {}
...
namespace org {
  namespace apache {
    namespace lucene {
      namespace codecs {
        namespace lucene42 {
          extern PyTypeObject PY_TYPE(Lucene42Codec);

          class t_Lucene42Codec {
          public:
            PyObject_HEAD
            Lucene42Codec object;
            static PyObject *wrap_Object(const Lucene42Codec&);
