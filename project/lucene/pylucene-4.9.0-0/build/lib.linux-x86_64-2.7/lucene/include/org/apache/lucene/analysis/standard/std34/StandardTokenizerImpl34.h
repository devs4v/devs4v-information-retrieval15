#ifndef org_apache_lucene_analysis_standard_std34_StandardTokenizerImpl34_H
#define org_apache_lucene_analysis_standard_std34_StandardTokenizerImpl34_H
      ...
      namespace analysis {
        namespace standard {
          namespace std34 {
            ...
            class StandardTokenizerImpl34 : public ::java::lang::Object {
            public:
              enum {
                mid_init$_cf2e3c10,
              ...
              explicit StandardTokenizerImpl34(jobject obj) : ::java::lang::Object(obj) {
                if (obj != NULL)
                  env->getClass(initializeClass);
              }
              StandardTokenizerImpl34(const StandardTokenizerImpl34& obj) : ::java::lang::Object(obj) {}
              ...
              StandardTokenizerImpl34(const ::java::io::Reader &);
  ...
  namespace apache {
    namespace lucene {
      namespace analysis {
        namespace standard {
          namespace std34 {
            extern PyTypeObject PY_TYPE(StandardTokenizerImpl34);

            class t_StandardTokenizerImpl34 {
            public:
              PyObject_HEAD
              StandardTokenizerImpl34 object;
              static PyObject *wrap_Object(const StandardTokenizerImpl34&);
