#ifndef org_apache_lucene_codecs_lucene49_Lucene49Codec_H
#define org_apache_lucene_codecs_lucene49_Lucene49Codec_H
    ...
    namespace lucene {
      namespace codecs {
        namespace lucene49 {
          ...
          class Lucene49Codec : public ::org::apache::lucene::codecs::Codec {
          public:
            enum {
              mid_init$_54c6a166,
            ...
            explicit Lucene49Codec(jobject obj) : ::org::apache::lucene::codecs::Codec(obj) {
              if (obj != NULL)
                env->getClass(initializeClass);
            }
            Lucene49Codec(const Lucene49Codec& obj) : ::org::apache::lucene::codecs::Codec(obj) {}
...
namespace org {
  namespace apache {
    namespace lucene {
      namespace codecs {
        namespace lucene49 {
          extern PyTypeObject PY_TYPE(Lucene49Codec);

          class t_Lucene49Codec {
          public:
            PyObject_HEAD
            Lucene49Codec object;
            static PyObject *wrap_Object(const Lucene49Codec&);
